...
declare const enum DAL {
    ...
    CFG_PIN_GROVE1 = 1036,
    CFG_PIN_SS = 1037,
    // /pxtapp/dynamixel/dynamixel_master.h
    DEVICE_ID_DYNAMIXEL = 40000,
    CFG_PIN_DXL_RX = 40000,
    CFG_PIN_DXL_TX = 40001,
    CFG_PIN_DXL_DIR = 40002,
    CFG_PIN_DXL_PWR = 40003,
    BaudRate1M = 1000000,
    ...
    DXL_INST_ACTION = 5,
    DXL_INST_FACTORY_RESET = 6,
    DXL_INST_REBOOT = 8,
    DXL_INST_CLEAR = 16,
    DXL_INST_STATUS = 85,
    DXL_INST_SYNC_READ = 130,
    DXL_INST_SYNC_WRITE = 131,
    DXL_INST_BULK_READ = 146,
    DXL_INST_BULK_WRITE = 147,
