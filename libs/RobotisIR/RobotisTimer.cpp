...
static RobotisTimer *CM300RobotisIR_device_instance = NULL;
...
void RobotisTimer::statusIRStop()
{
    lowTimer.disableIRQ();
    lowTimer.disable();
...
void RobotisTimer::statusIRStart()
{
...
void RobotisTimer::timerIRQ(uint16_t)
{
...
int RobotisTimer::getRobotisIRValue(uint8_t Direction)
{
